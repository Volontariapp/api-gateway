...
@ApiForbiddenResponse('You do not have permission to view posts as admin')
@ApiInternalServerErrorResponse('An unexpected error occurred on the server')
@GatewayController(`AdminPost`)
@Controller('admin/posts')
export class AdminPostQueryController extends BasePostGrpcController {
  // TODO: Add admin-specific query endpoints here (e.g. get all posts without filters)
}
